...
layui.define(['element', 'common'], function(exports) {
	...
	Tab.prototype.tabAdd = function(data) {
		...
		if(tabIndex === -1) {
			globalTabIdIndex++;
			var content = '<div style="-webkit-overflow-scrolling:touch; overflow: auto; height: 100%;width: 100%;"><iframe name="tabIframe" scrolling="yes"  src="' + data.href + '" data-id="' + globalTabIdIndex + '"></iframe></div>';
			var title = '';
