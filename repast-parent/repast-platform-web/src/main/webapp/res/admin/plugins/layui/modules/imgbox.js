...
(function($, undefined) {
		...
		var elem, opts, preloader, orig_pos, final_pos, busy = false, nr, zindex = 99999999, titleh = 0, shadow = 20, margin = 20, fx = $.extend($('<div/>')[0], { prop: 0 });
  ...
  exports('imgbox', null);
}).addcss('modules/imgbox/imgbox.css','skinimgboxcss');