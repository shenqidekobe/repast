...
<body>
		...
		<blockquote class="layui-elem-quote">
		  <form action="" id="listForm" class="layui-form">
			<div class="layui-input-inline">
				<input type="text" name="name" id="name" lay-verify="name" placeholder="菜单名" autocomplete="off" class="layui-input">
			</div>
	...
	<script type="text/javascript" src="${_PATH}/res/admin/js/catalog/list.js"></script>
</body>
</html>