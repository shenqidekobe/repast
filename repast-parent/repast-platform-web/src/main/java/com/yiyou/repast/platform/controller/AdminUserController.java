...
import com.yiyou.repast.platform.base.RBeanUtils;
...
public class AdminUserController extends BaseController{
	...
	public String listData(Model model, String loginName, String status,Integer page, Integer pageSize) {
		...
		model.addAttribute("dataPage", adminPage);
	...
	public void validateParam(String loginName, Integer id,HttpServletResponse rsp) {
	...
	public String remove(Integer id, HttpServletRequest request) {
		Integer userId=getAdminUserId(request);
		if(id.equals(userId)){
